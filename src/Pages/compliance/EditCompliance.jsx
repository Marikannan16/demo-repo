        ...
        <div className="grid grid-cols-1 gap-2 mb-6 lg:grid-cols-2 lg:gap-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="mb-2">
              ...
              {compliance.documentPdf && <button type="button" className=" w-24 h-6 bg-primary text-white rounded ps-2 text-center mt-2" onClick={()=>replaceRef.current.click()}>Replace</button>}
            </div>
          </div>
        </div>
